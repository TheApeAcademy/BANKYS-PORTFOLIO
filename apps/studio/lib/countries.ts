// Full set of ISO 3166 countries with their international calling codes,
// alphabetical by name. "Other" stays last as a catch-all for anything
// unlisted or a territory without its own code.
