...
const en = {
  ...
  "config.done.saveLink.body":
    "This is the only way back into your project — use it to check progress, pay, or message us. We've also included it in the WhatsApp message below.",
  "config.done.copy": "Copy",
  "config.done.copied": "Copied",
  "config.done.whatsappNote":
    "WhatsApp should have opened with your project details and this link — send it across and we'll pick up the conversation. Ready to lock it in?",
  "config.done.payNow": "Pay now — {amount}",
  "config.done.chatWhatsapp": "Chat on WhatsApp →",
  "config.done.bookmark": "Bookmark this page — you can come back anytime to review, edit, or pay later.",
...
const es: Record<keyof typeof en, string> = {
  ...
  "config.done.saveLink.body":
    "Es la única forma de volver a tu proyecto — úsalo para ver el progreso, pagar o escribirnos. También lo incluimos en el mensaje de WhatsApp de abajo.",
  "config.done.copy": "Copiar",
  "config.done.copied": "Copiado",
  "config.done.whatsappNote":
    "WhatsApp debería haberse abierto con los detalles de tu proyecto y este enlace — envíalo y seguimos la conversación. ¿Listo para confirmarlo?",
  "config.done.payNow": "Pagar ahora — {amount}",
  "config.done.chatWhatsapp": "Chatear por WhatsApp →",
  "config.done.bookmark": "Guarda esta página en marcadores — puedes volver cuando quieras para revisar, editar o pagar más tarde.",
