...
import { formatMoney, formatDateTime, mondayOf } from "@/lib/format";
  ...
  return (
    <div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Link href="/admin/payouts" className="lg:col-span-1">
        ...
        <Link href="/admin/projects" className="lg:col-span-1">
          <Card className="h-full transition hover:border-accent">
        ...
        <Link href="/admin/collaborators" className="lg:col-span-1">
          <Card className="h-full transition hover:border-accent">
