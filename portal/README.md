...
Next.js (App Router) + Supabase app covering the whole Zebraish product surface on one
shared dataset and one deployment:
...
via self-signup — they'll receive a confirmation email, or you can confirm manually in
